...
const user_id = "org1_department1_head"                  // role : (Business Entity) org1_department1_head
const user_psw = "org1_department1_headpw"
...
async function main() {
    try {
        ...
        const caInfo = ccp.certificateAuthorities['ca.org1.sample.com'];
