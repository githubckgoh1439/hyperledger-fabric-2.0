...
const userRegister = "org2_department1_user_2007"
    ...
    try {
        ...
        const listener = async (event) => {
            if (event.eventName === 'CreateEvent') {
                ...
                // eg. {"Code":"0","EventName":"CreateEvent","TxId":"09d21ddd5ab977e1dcce0159a4c96b7902adf3fef293870a90d282f0efd7fcda","ItemId":"","SymbolId":"symbol-221","Description":"Create Token Successfully"}
                ...
                // eg. {"Code":"0","EventName":"BurnEvent","TxId":"c6e72533a70e9d2d6db8af5aa1a722a057023b1f34899ccfd7b28a7e6734eda0","ItemId":"116-b-b-ITEM","SymbolId":"symbol-221","Description":"Burn Item Successfully"}
                ...
                // eg. {"Code":"0","EventName":"EndorseEvent","TxId":"e0d1421b12a78efa46a765d6de321d83ab87a93af26f6362c4221ef638aa154f","ItemId":"116-b-b-ITEM","SymbolId":"symbol-221","Description":"Endorsed Item Successfully"}
                console.log('Endorse-item Event Listener: ' + JSON.stringify(details));
            }else if (event.eventName === 'UpdateItemMetadataEvent') {
                var details = event.payload.toString('utf8');    
                details = JSON.parse(details)
 
                // eg. {"Code":"0","EventName":"UpdateItemMetadataEvent","TxId":"4298847a33a3dc4c0812665ac5ef641ba007cf2547b9f5b13aa8336346f9659e","ItemId":"221-ITEM","SymbolId":"symbol-221","Description":"Update Item Metadata Successfully"}
        ...
        // var returnvalue_create = await contract.submitTransaction('create','symbol-221_name','symbol-221','metadata_123456789','22');  
        ...
        // var returnvalue_getToken =  await contract.evaluateTransaction('getToken', 'symbol-221');
        ...
        // var returnvalue_mint = await contract.submitTransaction('mint','symbol-221', 'org1_department1_user_1950', '221-ITEM', 'properties: xxxx-ITEM', 'metadata: xxxx-ITEM');    
        // console.log('\nTransaction has been submitted' + returnvalue_mint);

        // // ////2.1  '{"Args":["getItem","symbol57", "57-ITEM"]}'
        // var returnvalue_getItem = await contract.evaluateTransaction('getItem', 'symbol-221', '221-ITEM');
        // console.log('\nTransaction has been evaluated for GETITEM: ' + returnvalue_getItem);

        // // ////3. Endorse : {'Args':['endorse', 'symbol-221', '221-ITEM']}'
        // var returnvalue_endorse = await contract.submitTransaction('endorse', 'symbol-221', '221-ITEM', 'remarks: endorsed by XXX 2nd-time');
        // console.log('\nTransaction has been submitted for ENDORSE: ' + returnvalue_endorse);

        // // ////4.  '{'Args':['getItem', 'symbol-221', '221-ITEM']}'
        // var returnvalue_getItem = await contract.evaluateTransaction('getItem', 'symbol-221', '221-ITEM');
        // console.log('\nTransaction has been evaluated for GETITEM: ' + returnvalue_getItem);

        // //5. Transfer-item: '{'Args':['transfer', 'symbol-221', 'alice11', 'bob', '221-ITEM']}'
        // var returnvalue_transfer = await contract.submitTransaction('transfer', 'symbol-221', 'alice111', 'bob', '221-ITEM');
        // console.log('\nTransaction has been submitted for TRANSFER: ' + returnvalue_transfer);

        // //5.2  '{'Args':['getItem', 'symbol-221', '221-ITEM']}'
        // var returnvalue_getItem =  await contract.evaluateTransaction('getItem', 'symbol-221', '221-ITEM');
        // console.log('\nTransaction has been evaluated for GETITEM : ' + returnvalue_getItem);
 
        // //6. Burn-item : '{'Args':['burn', 'symbol-221',  'bob', '221-ITEM']}'
        // var returnvalue_burn = await contract.submitTransaction('burn', 'symbol-221',  'bob', '221-ITEM');
        // console.log('\nTransaction has been submitted for BURN: ' + returnvalue_burn);

        // //7.  '{'Args':['getItem', 'symbol-221', '221-ITEM']}'
        // var returnvalue_getItem =  await contract.evaluateTransaction('getItem', 'symbol-221', '221-ITEM');
        // console.log('\nTransaction has been evaluated for GETITEM : ' + returnvalue_getItem);
