...
# export PEER0_ORG3_CA=${PWD}/organizations/peerOrganizations/org3.avantas.com/peers/peer0.org3.avantas.com/tls/ca.crt

# Set OrdererOrg.Admin globals
setOrdererGlobals() {
  export CORE_PEER_LOCALMSPID="OrdererMSP"
  export CORE_PEER_TLS_ROOTCERT_FILE=${PWD}/organizations/ordererOrganizations/avantas.com/orderers/orderer.avantas.com/msp/tlscacerts/tlsca.avantas.com-cert.pem
  export CORE_PEER_MSPCONFIGPATH=${PWD}/organizations/ordererOrganizations/avantas.com/users/Admin@avantas.com/msp
}
...
setGlobals() {
  ...
  #   export CORE_PEER_MSPCONFIGPATH=${PWD}/organizations/peerOrganizations/org3.avantas.com/users/Admin@org3.avantas.com/msp
